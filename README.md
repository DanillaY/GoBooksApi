...
*	🟢 /getBookByStructuredSearch [<span style="color:rgba(9,234,87, 1);">*GET*</span>] - эндпоинт, который отвечает за получение массива книг с более подробным поиском, принимаемые параметры: search, category, author.
...
##### Query параметры для метода getBookByStructuredSearch
